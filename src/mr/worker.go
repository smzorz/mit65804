...
// creat temp files
func createTempFiles(reply *RegisterReply) ([]*json.Encoder, []string, []*os.File) {
	...
	return encoders, tempfilenames, tempFiles
}
...
func Worker(mapf func(string, string) []KeyValue, reducef func(string, []string) string) {
	for {
		...
		switch reply.Type {
			case MapTask:
				{
					encoders, tempfilenames, tempFiles := createTempFiles(&reply)
